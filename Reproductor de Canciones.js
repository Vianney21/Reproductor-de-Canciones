...
let canciones = [
    {
        id:0,
        artista:'(supercell) ft. Mafumafu, gaku',
        titulo:'Takt',
        caratula:'Takt Op. Destiny.jpg',
        archivo:'Takt Op. Destiny.mp3'
    },
    {
        id:1,
        artista:'Aimer',
        titulo:'Zankyou Sanka',
        caratula:'Aimer - Zankyou Sanka.jpg',
        archivo:'Aimer - Zankyou Sanka.mp3'
    },
    {
        id:2,
        artista:'Syudou',
        titulo:'Gambling',
        caratula:'Gambling.jpg',
        archivo:'Gambling.mp3'
    },
    {
        id:3,
        artista:'Blue Encount',
        titulo:'Polaris',
        caratula:'Bnha 4 season.png',
        archivo:'Polaris.mp3'
    },
    {
        id:4,
        artista:'Visual Prisom',
        titulo:'Zankoku Shangri-La',
        caratula:'Visual Prison.jpg',
        archivo:'Zankoku Shangri-La.mp3'
    },
...
{
    cancion.src = 'audios/'+canciones[indice].archivo;
    caratula.src = 'imagenes/'+canciones[indice].caratula;
...
function generarLista(songs){
    ...
    for(let item of songs)
    {
        ...
        <article class="list-item" id="${item.id}">
            <img src="imagenes/${item.caratula}">
            <div class="data">
...
function buscar() {
    ...
    document.getElementById("encontrar").innerHTML = 0;
    var divResultados = document.getElementById("resultados");
    divResultados.innerHTML = "";
    var cadenaBusca = inputPatron.value;
    var item = 0;
